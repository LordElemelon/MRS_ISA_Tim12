...
export class RoomApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for roomReservations.
   *
   * @param {any} id room id
   *
   * @param {any} fk Foreign key for roomReservations
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdRoomReservations(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/roomReservations/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for roomReservations.
   *
   * @param {any} id room id
   *
   * @param {any} fk Foreign key for roomReservations
   ...
   * This method returns no data.
   */
  public destroyByIdRoomReservations(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/roomReservations/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for roomReservations.
   *
   * @param {any} id room id
   *
   * @param {any} fk Foreign key for roomReservations
   ...
   * </em>
   */
  public updateByIdRoomReservations(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/roomReservations/:fk";
    let _routeParams: any = {
  ...
  /**
   * Queries roomReservations of room.
   *
   * @param {any} id room id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getRoomReservations(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/roomReservations";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in roomReservations of this model.
   *
   * @param {any} id room id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createRoomReservations(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/roomReservations";
    let _routeParams: any = {
  ...
  /**
   * Deletes all roomReservations of this model.
   *
   * @param {any} id room id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteRoomReservations(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/roomReservations";
    let _routeParams: any = {
  ...
  /**
   * Counts roomReservations of room.
   *
   * @param {any} id room id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countRoomReservations(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/roomReservations/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `retval` – `{object}` - 
   */
  public findAvailableRooms(start: any, end: any, location: any = {}, price: any = {}, beds: any, customHeaders?: Function): Observable<Room[]> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    ...
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result.pipe(map((instances: Array<Room>) =>
   ...
   * </em>
   */
  public createManyRoomReservations(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/roomReservations";
    let _routeParams: any = {
